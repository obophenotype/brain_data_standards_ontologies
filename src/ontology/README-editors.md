...
Make sure you have an ID range in the [idranges file](bdscratch-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [bdscratch-edit.owl](bdscratch-edit.owl)

** DO NOT EDIT bdscratch.obo OR bdscratch.owl in the top level directory **

[../../bdscratch.owl](../../bdscratch.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/bdscratch) for details.
 ...
 * [bdscratch-idranges.owl](bdscratch-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/bdscratch_terms.txt file
...
Note: the bdscratch_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as bdscratch.owl and bdscratch.obo and places
 ...
 * https://github.com/obophenotype/bdscratch/releases
 * https://github.com/obophenotype/bdscratch/releases/new
...
what is in the `owl:versionIRI` of the derived bdscratch.owl (`data-version` in
bdscratch.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/bdscratch.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/bdscratch/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/bdscratch.svg?branch=master)](https://travis-ci.org/obophenotype/bdscratch)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to bdscratch
