...
2. CSV mapping files that combine dendogram nodes into groupings that do not correspond to any single dendrogram node, but do correspond to known cell types.
